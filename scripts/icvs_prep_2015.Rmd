...
#giving filling spain from regional responses
...
summary(wat$country)[summary(wat$country) >0]

#icvs_data[is.na(icvs_data$country),]
...
math checks out for united kingdom

missing cases for peru (7011 vs 10300), argentina (2529 vs 5260)

does have slovenia, "RSA" (probably south africa)
