...
This interactive table suggests that these observations are lacking country identification. They have latin america for global region, but nothing more specific 

```{r look at data}
data_2005[is.na(data_2005$country),]
```
