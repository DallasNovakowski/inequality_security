...
# takes about an hour
m100_ord <- mod_joined %>% map(~ ordinal::clmm(ordered(num_victim_5yr_assault_winz) ~  
                                                 gdppc_2004_6_scale + gini_2004_6_cent + 
                                                 age_cent + employed + male + police_effective + income_quartile + 
                                                 (1 | country), data = .x))
