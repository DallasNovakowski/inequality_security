...
rm(vic_var_assault, vic_var_drop)
```
...
```{r merging}
save(iv_2005, iv_2005_lib, iv_2005_mod, sweep5_nrow, sweep5_countries, file = "C:/Users/dalla/Google Drive/data_files/icvs_pwt_swiid/data/iv_2005.RData")
