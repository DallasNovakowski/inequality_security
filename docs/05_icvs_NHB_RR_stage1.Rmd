...
Important resources such as money, territory, status, or food tend to be contested. Inequality describes whether a resource is distributed unevenly between agents, with some parties getting more than their neighbors (REF). Inequality increases the stakes of competitions: beating one's peers can grant access to institutional influence, life-saving medications, or being able to feed one's family. In an unequal environment, falling behind can carry serious consequences, and humans are quick to respond to these conditions.

According to risk-sensitivity theory [RST, @caraco1980], many risk-taking behaviours can be understood as an adaptive response to desperate circumstances. Originally conceived to explain the foraging behaviours of birds, RST predicts that organisms will be more likely to choose risky options when they cannot meet their goals (e.g., daily calorie requirements) through more predictable means.

Biologically speaking, the ultimate goal of evolved features is to improve one's reproductive fitness relative to

successful competitors pass more of their genes onto future generations, meaning that fitness must be considered relative to competitors (Hamilton,

10

1964).

<!--# For instance, when close to starvation, a hummingbird might prefer flowers that gives large but unpredictable amounts of nectar, compared to flowers that give smaller, more consistent amounts. are in a state of need-->

<!--# In risk-sensitivity theory, decision-making is characterized as a behavioral response designed to seek foraging returns in stochastic environments that allow for survival, with the ultimate goal of enhancing reproductive success or fitness (Bednekoff, 1996; Hurly, 2003; Stephens, 1981; Stephens & Krebs, 1986; Weber, Shafir, & Blais, 2004). -->
