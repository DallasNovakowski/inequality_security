...
According to risk-sensitivity theory [RST, @caraco1980], many risk-taking behaviours can be understood as an adaptive response to desperate circumstances. Originally conceived to explain the foraging behaviours of birds, RST predicts that organisms will be more likely to choose risky options when they cannot meet their goals (e.g., daily calorie requirements) through more predictable means. Accordingly, inequality tends place goals further from one's reach, through means material or psychological.
