...
A growing body of evidence suggests that economic inequality leads to increased risk-taking and conflict in humans. In a "winner-takes-all" environment, individuals are more likely to resort to risky and criminal activities out of desperation, to effectively compete for contested positions and resources [@payne2017]. Despite modern societies becoming increasingly unequal [@saez2016], there is little research examining whether inequality causes people to *expect* desperation and risk-taking from others.
