...
mw100_invalid <- lapply(seq_along(mw100_ord), function(i) {
 mw100_valid[[i]] <- is.nan(summary(mw100_ord[[i]])$coefficients[,"Std. Error"]["gini_2004_6_cent"])
  return(mw100_valid[[i]])
}) 
...
model_nonconvergence <- percent(Reduce("+",mw100_invalid)/length(mw100_invalid))
