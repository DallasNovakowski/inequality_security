...
Given that the SWIID is presented in a list of 100 different dataframes, the analysis will firstly be conducted on each dataframe, with the results stored separately, and aggregated upon reporting.
...
xtmixed total_security num_victim_5yr gini_cent gdppc_2004_6_scale police_effective income_quartile age_cent employed male [pw=individual_weight] || country:, pwscale(size)
...
*Winzorized model
xtmixed num_victim_5yr_winz gini_wc gdppc_2004_6_ws age_cent employed male police_effective income_quartile [pw=individual_weight] || country:, pwscale(size)

*xtmixed num_victim_5yr_winz victim_nation_mean gini_wc gdppc_2004_6_ws age_cent employed male police_effective income_quartile [pw=individual_weight] || country:, pwscale(size)
...
*Winzorized model
xtmixed num_victim_5yr_winz gini_wc gdppc_2004_6_ws age_cent employed male police_effective income_quartile [pw=individual_weight] || country: if dropcook !=1, pwscale(size)
...
mepoisson total_security num_victim_5yr gini_cent gdppc_2004_6_scale police_effective income_quartile age_cent employed male [pw=individual_weight] || country:, pwscale(size)
```
...
xtmixed num_victim_5yr gini_cent gdppc_2004_6_cent age_cent employed male [pw=individual_weight] || country:, pwscale(size)
