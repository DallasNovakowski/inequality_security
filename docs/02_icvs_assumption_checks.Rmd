...
haven::write_dta(iv_2005,"C:/Users/dalla/Google Drive/data_files/icvs_pwt_swiid/data/joined_sample.dta")
```

```{stata empty model, collectcode = TRUE}
use "C:/Users/dalla/Google Drive/data_files/icvs_pwt_swiid/data/joined_sample.dta", clear
