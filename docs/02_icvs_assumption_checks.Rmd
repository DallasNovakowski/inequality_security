...
# mean centering gdp
iv_2005[["gdppc_2004_6_cent"]] <-  iv_2005[["gdppc_2004_6"]] - mean(iv_2005[["gdppc_2004_6"]])
```
...
haven::write_dta(iv_2005,"C:/Users/dalla/Google Drive/project_files/icvs_inequality/data/joined_sample.dta")
```

```{stata empty model, collectcode = TRUE}
use "C:\Users\dalla\Google Drive\project_files\icvs_inequality\data\joined_sample.dta", clear
...
```{stata winzorized model, collectcode = TRUE}
use "C:\Users\dalla\Google Drive\project_files\icvs_inequality\data\joined_sample.dta"
...
```{r create flags and update data}
