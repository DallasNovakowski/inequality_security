...
(ref:pretest-splitplot) Means (95% CI) and distributions for Study 1 pretest. n=`r screened_n`, within-subjects, *p*s \> `r plyr::round_any(sort(pretest_anova[,"Pr(>F)"],FALSE)[1], 0.01, f = floor)`. See Table \@ref(tab:pretest-anova).
...
(ref:mixed-design) Study design for a priori power analysis for 2b\*2w mixed ANOVA experiments (Study 1a & b). Note: Max possible value is \$1.00; bars indicate +/-1 *SD*
...
(ref:powerplot2) Per-condition sample size thresholds for 95% power in main effect of inequality for 2b\*2w mixed ANOVA experiments (Study 1a & b).
...
knitr::kable(tidy_pretest_model1,
             align = "lcccccc",
             caption = 'Mixed model results for Study 1 pretest', booktabs = TRUE)
```
...
knitr::kable(round(security_2b2b_f01_exact$main_results,4), caption = 'Power of main and interaction effects for 2b*2b factorial designs (Studies 1c, d)', booktabs = TRUE)
```
...
knitr::kable(round(security_2b2b_f01_exact$pc_results,2), caption = 'Power of pairwise comparisons for 2b*2b factorial designs (t-test; Studies 1c,d)', booktabs = TRUE)
```



```{r s2-victim-table-iv,echo=FALSE,  eval = TRUE, include=TRUE}
iv_tidy_ci$term <- recode(iv_tidy_ci$term,  gini_2004_6_cent = "Inequality(Gini)",gdppc_2004_6_scale  = "GDP", age_cent="Age",employed1="Employed",male1="Male",police_effective="P.police effectiveness",income_quartile= "Income quartile")
...
iv_tidy_ci %>%
  ...
  kbl(booktabs = T,
      align = "lcccccc",
      caption = paste("Results for (pilot)  multilevel analysis, predicting victimization, larger targeted sample, n = ",
...
min_tidy_ci$term <- recode(min_tidy_ci$term, gini_2004_6_cent = "Inequality(Gini)",gdppc_2004_6_scale  = "GDP", age_cent="Age",employed1="Employed",male1="Male",police_effective="P.police effectiveness",income_quartile= "Income quartile")
...
tidy_ci$term <- recode(tidy_ci$term,  gini_2004_6_cent = "Inequality(Gini)", gdppc_2004_6_scale  = "GDP", age_cent="Age",employed1="Employed",male1="Male",police_effective="P.police effectiveness",income_quartile= "Income quartile")
